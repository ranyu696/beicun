...
export function ChannelTypeList() {
  ...
  useEffect(() => {
    const fetchTypes = async () => {
      try {
        const response = await fetch('/api/categories/channel-types')
  ...
  const handleStatusChange = async (id: string, checked: boolean) => {
    try {
      const response = await fetch(`/api/categories/channel-types/${id}`, {
        method: 'PATCH',
        headers: {
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await fetch(`/api/categories/channel-types/${deleteId}`, {
        method: 'DELETE',
      })
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem asChild>
                          <Link href={`/admin/categories/channel-types/${type.id}/edit`}>
