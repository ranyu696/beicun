...
export function MaterialTypeList() {
  ...
  useEffect(() => {
    const fetchTypes = async () => {
      try {
        const response = await fetch('/api/categories/material-types')
  ...
  const handleStatusChange = async (id: string, checked: boolean) => {
    try {
      const response = await fetch(`/api/categories/material-types/${id}`, {
        method: 'PATCH',
        headers: {
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await fetch(`/api/categories/material-types/${deleteId}`, {
        method: 'DELETE',
      })
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem asChild>
                          <Link href={`/admin/categories/material-types/${type.id}/edit`}>
